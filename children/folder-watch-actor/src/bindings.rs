...
pub mod patina {
    ...
    pub mod connect {
        ...
        pub mod connect {
            ...
            unsafe impl _rt::WasmResource for Binding {
                #[inline]
                unsafe fn drop(_handle: u32) {
                    ...
                    {
                        #[link(wasm_import_module = "patina:connect/connect@0.2.0")]
                        unsafe extern "C" {
                            #[link_name = "[resource-drop]binding"]
                            fn drop(_: u32);
                        }
                        unsafe { drop(_handle) };
                    }
            ...
            pub fn resolve(name: &str) -> Result<Binding, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
                        ...
                        0 => {
                            let e = {
                                let l4 = *ptr1
                                    .add(::core::mem::size_of::<*const u8>())
                                    .cast::<i32>();
                                unsafe { Binding::from_handle(l4 as u32) }
                            };
                            Ok(e)
                        }
                        1 => {
        ...
        pub mod events_stream {
            ...
            pub fn subscribe(
                ...
                unsafe {
                    ...
                    let vec0 = stream_name;
                    let ptr0 = vec0.as_ptr().cast::<u8>();
                    let len0 = vec0.len();
                    let (result1_0, result1_1) = match after {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(
                        wasm_import_module = "patina:events-stream/events-stream@0.1.0"
                    )]
                    unsafe extern "C" {
                        #[link_name = "subscribe"]
                        fn wit_import3(
                            ...
                            let e = {
                                ...
                                for i in 0..len20 {
                                    ...
                                    let e20 = {
                                        ...
                                        Event {
                                            stream_name: _rt::string_lift(bytes9),
                                            offset: l10 as u64,
                                            event_type: _rt::string_lift(bytes13),
                                            payload: _rt::string_lift(bytes16),
                                            occurred_at: _rt::string_lift(bytes19),
                                        }
                                    };
                                    result20.push(e20);
                                }
                                _rt::cabi_dealloc(
                                    base20,
                                    len20 * (8 + 8 * ::core::mem::size_of::<*const u8>()),
                                    8,
                                );
                                result20
                            };
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn ack(stream_name: &str, offset: u64) -> Result<(), _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
    ...
    pub mod git {
        ...
        pub mod git {
            ...
            use super::super::super::_rt;
            #[allow(unused_unsafe, clippy::all)]
            pub fn create_tag(name: &str) -> Result<(), _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
                    ...
                    let ptr1 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "patina:git/git@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "create-tag"]
                        fn wit_import2(_: *mut u8, _: usize, _: *mut u8);
                    }
                    #[cfg(not(target_arch = "wasm32"))]
                    unsafe extern "C" fn wit_import2(_: *mut u8, _: usize, _: *mut u8) {
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn create_tag_at(name: &str, git_ref: &str) -> Result<(), _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn delete_tag(name: &str) -> Result<(), _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn tag_exists(name: &str) -> Result<bool, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn commit(message: &str) -> Result<_rt::String, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn diff_stat() -> Result<_rt::String, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn status_porcelain() -> Result<_rt::String, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn add_paths(paths: &[_rt::String]) -> Result<(), _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn remove_paths(paths: &[_rt::String]) -> Result<(), _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn is_clean_tracked() -> Result<bool, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn commits_behind_upstream() -> Result<u32, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
                    ...
                    #[link(wasm_import_module = "patina:git/git@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "commits-behind-upstream"]
                        fn wit_import1(_: *mut u8);
                    }
                    #[cfg(not(target_arch = "wasm32"))]
                    unsafe extern "C" fn wit_import1(_: *mut u8) {
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn is_diverged() -> Result<bool, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
        ...
        pub mod peer {
            ...
            pub fn call(
                ...
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "patina:peer/peer@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "call"]
                        fn wit_import4(
                            _: *mut u8,
        ...
        pub mod task {
            ...
            pub fn enqueue(
                ...
                unsafe {
                    ...
                    let ptr1 = vec1.as_ptr().cast::<u8>();
                    let len1 = vec1.len();
                    let (result3_0, result3_1, result3_2) = match dedupe_key {
                        Some(e) => {
                            let vec2 = e;
                            let ptr2 = vec2.as_ptr().cast::<u8>();
                            let len2 = vec2.len();
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "patina:task/task@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "enqueue"]
                        fn wit_import5(
                            _: *mut u8,
    ...
    pub mod watch {
        ...
        pub mod events {
            ...
            static __FORCE_SECTION_REF: fn() = super::super::super::__link_custom_section_describing_imports;
            use super::super::super::_rt;
            pub type FileChange = super::super::super::patina::watch::types::FileChange;
            #[allow(unused_unsafe, clippy::all)]
            pub fn emit(change: &FileChange) -> Result<(), _rt::String> {
                unsafe {
                    #[repr(align(8))]
                    struct RetArea(
                        [::core::mem::MaybeUninit<
                    ...
                    let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
                    let super::super::super::patina::watch::types::FileChange {
                        watcher: watcher1,
                        stream_name: stream_name1,
                        change_kind: change_kind1,
                        absolute_path: absolute_path1,
                        relative_path: relative_path1,
                        size_bytes: size_bytes1,
                        modified_unix_ms: modified_unix_ms1,
                        sha256: sha2561,
                        detected_at: detected_at1,
                    } = change;
                    let vec2 = watcher1;
                    let ptr2 = vec2.as_ptr().cast::<u8>();
                    let len2 = vec2.len();
                    ...
                    *ptr0.add(4 * ::core::mem::size_of::<*const u8>()).cast::<u8>() = (change_kind1
                        .clone() as i32) as u8;
                    let vec4 = absolute_path1;
                    let ptr4 = vec4.as_ptr().cast::<u8>();
                    let len4 = vec4.len();
                    ...
                    *ptr0
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "patina:watch/events@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "emit"]
        ...
        pub mod types {
            ...
            unsafe impl _rt::WasmResource for Fields {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                        #[link(wasm_import_module = "wasi:http/types@0.2.8")]
                        unsafe extern "C" {
        ...
        pub mod outgoing_handler {
            ...
            pub fn handle(
                ...
                unsafe {
                    ...
                    let ptr1 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:http/outgoing-handler@0.2.8")]
                    unsafe extern "C" {
                        #[link_name = "handle"]
                        fn wit_import2(_: i32, _: i32, _: i32, _: *mut u8);
                    }
        ...
        pub mod readwrite {
            ...
            impl ::core::fmt::Debug for DataType {
                fn fmt(
                    ...
                    match self {
                        ...
                        DataType::Float64(e) => {
                            f.debug_tuple("DataType::Float64").field(e).finish()
                        }
                        DataType::Text(e) => {
                            f.debug_tuple("DataType::Text").field(e).finish()
                        }
                        DataType::Flag(e) => {
                            f.debug_tuple("DataType::Flag").field(e).finish()
                        }
                        DataType::Binary(e) => {
            ...
            unsafe impl _rt::WasmResource for Connection {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                        #[link(wasm_import_module = "wasi:sql/readwrite@0.1.0")]
                        unsafe extern "C" {
            ...
            impl Statement {
                ...
                pub fn query(&self) -> _rt::String {
                    unsafe {
                        ...
                        #[link(wasm_import_module = "wasi:sql/readwrite@0.1.0")]
                        unsafe extern "C" {
                            #[link_name = "[method]statement.query"]
                            fn wit_import1(_: i32, _: *mut u8);
                        }
                        #[cfg(not(target_arch = "wasm32"))]
                        unsafe extern "C" fn wit_import1(_: i32, _: *mut u8) {
            ...
            impl Statement {
                #[allow(unused_unsafe, clippy::all)]
                pub fn params(&self) -> _rt::Vec<_rt::String> {
                    unsafe {
                        #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                        #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                        struct RetArea(
                        ...
                        #[link(wasm_import_module = "wasi:sql/readwrite@0.1.0")]
                        unsafe extern "C" {
                            #[link_name = "[method]statement.params"]
                            fn wit_import1(_: i32, _: *mut u8);
                        }
                        #[cfg(not(target_arch = "wasm32"))]
                        unsafe extern "C" fn wit_import1(_: i32, _: *mut u8) {
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn open(name: &str) -> Result<Connection, Error> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
                        ...
                        0 => {
                            let e = {
                                let l6 = *ptr3
                                    .add(::core::mem::size_of::<*const u8>())
                                    .cast::<i32>();
                                unsafe { Statement::from_handle(l6 as u32) }
                            };
                            Ok(e)
                        }
                        1 => {
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn query(c: &Connection, s: &Statement) -> Result<_rt::Vec<Row>, Error> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
                    ...
                    unsafe {
                        wit_import1((c).handle() as i32, (s).handle() as i32, ptr0)
                    };
                    let l2 = i32::from(*ptr0.add(0).cast::<u8>());
                    let result24 = match l2 {
                        0 => {
                            let e = {
                                let l3 = *ptr0
                                    .add(::core::mem::size_of::<*const u8>())
                                        ...
                                        for i in 0..len19 {
                                            ...
                                            let e19 = {
                                                ...
                                                let v18 = match l7 {
                                                    ...
                                                    4 => {
                                                        let e18 = {
                                                            let l14 = i32::from(*base.add(8).cast::<u8>());
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn exec(c: &Connection, s: &Statement) -> Result<u32, Error> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
...
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 10311] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xbeO\x01A\x02\x01AR\x01\
B\x0b\x01m\x03\x07healthy\x08degraded\x09unhealthy\x04\0\x0dhealth-status\x03\0\0\
\x01ks\x01r\x02\x06status\x01\x06reason\x02\x04\0\x0cchild-health\x03\0\x03\x01m\
\x08\x0cfetch-source\x09run-query\x0aemit-facts\x11materialize-index\x0dverify-b\
elief\x0async-graph\x12refresh-credential\x0anative-job\x04\0\x10task-intent-kin\
d\x03\0\x05\x01r\x03\x04kind\x06\x0cpayload-jsons\x0adedupe-key\x02\x04\0\x0btas\
k-intent\x03\0\x07\x01r\x05\x0bstream-names\x06offsetw\x0aevent-types\x0cpayload\
-jsons\x0boccurred-ats\x04\0\x0dpending-event\x03\0\x09\x03\0\x20patina:child/ru\
ntime-types@0.1.0\x05\0\x02\x03\0\0\x0cchild-health\x03\0\x0cchild-health\x03\0\x01\
\x02\x03\0\0\x0dpending-event\x03\0\x0dpending-event\x03\0\x03\x02\x03\0\0\x0bta\
sk-intent\x03\0\x0btask-intent\x03\0\x05\x01B\x0a\x04\0\x08pollable\x03\x01\x01h\
...
in\x04\0\x05\x04\0\x04poll\x01\x06\x03\0\x12wasi:io/poll@0.2.8\x05\x07\x02\x03\0\
\x01\x08pollable\x01B\x0f\x02\x03\x02\x01\x08\x04\0\x08pollable\x03\0\0\x01w\x04\
...
bscribe-duration\x01\x0a\x03\0!wasi:clocks/monotonic-clock@0.2.8\x05\x09\x01B\x04\
\x04\0\x05error\x03\x01\x01h\0\x01@\x01\x04self\x01\0s\x04\0\x1d[method]error.to\
-debug-string\x01\x02\x03\0\x13wasi:io/error@0.2.8\x05\x0a\x02\x03\0\x03\x05erro\
r\x01B(\x02\x03\x02\x01\x0b\x04\0\x05error\x03\0\0\x02\x03\x02\x01\x08\x04\0\x08\
...
t-stream.blocking-splice\x01\x18\x03\0\x15wasi:io/streams@0.2.8\x05\x0c\x02\x03\0\
\x02\x08duration\x02\x03\0\x04\x0cinput-stream\x02\x03\0\x04\x0doutput-stream\x01\
B\xc0\x01\x02\x03\x02\x01\x0d\x04\0\x08duration\x03\0\0\x02\x03\x02\x01\x0e\x04\0\
\x0cinput-stream\x03\0\x02\x02\x03\x02\x01\x0f\x04\0\x0doutput-stream\x03\0\x04\x02\
\x03\x02\x01\x0b\x04\0\x08io-error\x03\0\x06\x02\x03\x02\x01\x08\x04\0\x08pollab\
...
\0\x8b\x01\x04\0\x0fhttp-error-code\x01\x8c\x01\x03\0\x15wasi:http/types@0.2.8\x05\
\x10\x02\x03\0\x05\x10outgoing-request\x02\x03\0\x05\x0frequest-options\x02\x03\0\
...
handle\x01\x0d\x03\0\x20wasi:http/outgoing-handler@0.2.8\x05\x15\x01B\x04\x01m\x06\
\x05trace\x05debug\x04info\x04warn\x05error\x08critical\x04\0\x05level\x03\0\0\x01\
@\x03\x05level\x01\x07contexts\x07messages\x01\0\x04\0\x03log\x01\x02\x03\0\x1aw\
asi:logging/logging@0.1.0\x05\x16\x01B\x1c\x01q\x03\x0dno-such-store\0\0\x0dacce\
ss-denied\0\0\x05other\x01s\0\x04\0\x05error\x03\0\0\x01ps\x01kw\x01r\x02\x04key\
s\x02\x06cursor\x03\x04\0\x0ckey-response\x03\0\x04\x04\0\x06bucket\x03\x01\x01h\
\x06\x01p}\x01k\x08\x01j\x01\x09\x01\x01\x01@\x02\x04self\x07\x03keys\0\x0a\x04\0\
\x12[method]bucket.get\x01\x0b\x01j\0\x01\x01\x01@\x03\x04self\x07\x03keys\x05va\
lue\x08\0\x0c\x04\0\x12[method]bucket.set\x01\x0d\x01@\x02\x04self\x07\x03keys\0\
\x0c\x04\0\x15[method]bucket.delete\x01\x0e\x01j\x01\x7f\x01\x01\x01@\x02\x04sel\
f\x07\x03keys\0\x0f\x04\0\x15[method]bucket.exists\x01\x10\x01j\x01\x05\x01\x01\x01\
@\x02\x04self\x07\x06cursor\x03\0\x11\x04\0\x18[method]bucket.list-keys\x01\x12\x01\
i\x06\x01j\x01\x13\x01\x01\x01@\x01\x0aidentifiers\0\x14\x04\0\x04open\x01\x15\x03\
\0\x19wasi:keyvalue/store@0.2.0\x05\x17\x01B\x05\x04\0\x07binding\x03\x01\x01i\0\
\x01j\x01\x01\x01s\x01@\x01\x04names\0\x02\x04\0\x07resolve\x01\x03\x03\0\x1cpat\
ina:connect/connect@0.2.0\x05\x18\x01B\x20\x01s\x04\0\x05error\x03\0\0\x01p}\x01\
q\x07\x05int32\x01z\0\x05int64\x01x\0\x07float64\x01u\0\x04text\x01s\0\x04flag\x01\
\x7f\0\x06binary\x01\x02\0\x04null\0\0\x04\0\x09data-type\x03\0\x03\x01p\x04\x01\
r\x01\x06values\x05\x04\0\x03row\x03\0\x06\x04\0\x0aconnection\x03\x01\x04\0\x09\
statement\x03\x01\x01h\x09\x01@\x01\x04self\x0a\0s\x04\0\x17[method]statement.qu\
ery\x01\x0b\x01ps\x01@\x01\x04self\x0a\0\x0c\x04\0\x18[method]statement.params\x01\
\x0d\x01i\x08\x01j\x01\x0e\x01\x01\x01@\x01\x04names\0\x0f\x04\0\x04open\x01\x10\
\x01i\x09\x01j\x01\x11\x01\x01\x01@\x02\x05querys\x06params\x0c\0\x12\x04\0\x07p\
repare\x01\x13\x01h\x08\x01p\x07\x01j\x01\x15\x01\x01\x01@\x02\x01c\x14\x01s\x0a\
\0\x16\x04\0\x05query\x01\x17\x01j\x01y\x01\x01\x01@\x02\x01c\x14\x01s\x0a\0\x18\
\x04\0\x04exec\x01\x19\x03\0\x18wasi:sql/readwrite@0.1.0\x05\x19\x01B\x06\x01ks\x01\
p}\x01o\x02ss\x01p\x02\x01r\x04\x05topics\x0ccontent-type\0\x04data\x01\x08metad\
ata\x03\x04\0\x07message\x03\0\x04\x03\0\x1awasi:messaging/types@0.2.0\x05\x1a\x02\
\x03\0\x0b\x07message\x01B\x0b\x02\x03\x02\x01\x1b\x04\0\x07message\x03\0\0\x04\0\
\x06client\x03\x01\x01i\x02\x01j\x01\x03\x01s\x01@\x01\x04names\0\x04\x04\0\x07c\
onnect\x01\x05\x01h\x02\x01j\x01w\x01s\x01@\x02\x06client\x06\x07message\x01\0\x07\
\x04\0\x04send\x01\x08\x03\0\x1dwasi:messaging/producer@0.2.0\x05\x1c\x01B\x0a\x01\
r\x05\x0bstream-names\x06offsetw\x0aevent-types\x07payloads\x0boccurred-ats\x04\0\
\x05event\x03\0\0\x01kw\x01p\x01\x01j\x01\x03\x01s\x01@\x03\x0bstream-names\x05a\
fter\x02\x05limity\0\x04\x04\0\x09subscribe\x01\x05\x01j\0\x01s\x01@\x02\x0bstre\
am-names\x06offsetw\0\x06\x04\0\x03ack\x01\x07\x03\0(patina:events-stream/events\
-stream@0.1.0\x05\x1d\x01B\x0b\x01o\x02ss\x01p\0\x01r\x03\x04names\x05valueu\x06\
labels\x01\x04\0\x06metric\x03\0\x02\x01j\0\x01s\x01@\x01\x06metric\x03\0\x04\x04\
\0\x04emit\x01\x05\x01@\x02\x04names\x05valueu\0\x04\x04\0\x05gauge\x01\x06\x01@\
\x02\x04names\x05deltau\0\x04\x04\0\x07counter\x01\x07\x03\0\x1cpatina:measure/m\
easure@0.1.0\x05\x1e\x01B\x04\x01ks\x01j\x01s\x01s\x01@\x03\x04kinds\x07payloads\
\x0adedupe-key\0\0\x01\x04\0\x07enqueue\x01\x02\x03\0\x16patina:task/task@0.1.0\x05\
\x1f\x01B\x03\x01j\x01s\x01s\x01@\x03\x05childs\x06actions\x07payloads\0\0\x04\0\
\x04call\x01\x01\x03\0\x16patina:peer/peer@0.1.0\x05\x20\x01B\x1c\x01j\0\x01s\x01\
@\x01\x04names\0\0\x04\0\x0acreate-tag\x01\x01\x01@\x02\x04names\x07git-refs\0\0\
\x04\0\x0dcreate-tag-at\x01\x02\x04\0\x0adelete-tag\x01\x01\x01j\x01\x7f\x01s\x01\
@\x01\x04names\0\x03\x04\0\x0atag-exists\x01\x04\x01j\x01s\x01s\x01@\x01\x07mess\
ages\0\x05\x04\0\x06commit\x01\x06\x01ps\x01j\x01\x07\x01s\x01@\x01\x05limity\0\x08\
\x04\0\x0blog-oneline\x01\x09\x01@\0\0\x05\x04\0\x09diff-stat\x01\x0a\x04\0\x10s\
tatus-porcelain\x01\x0a\x01@\x01\x05paths\x07\0\0\x04\0\x09add-paths\x01\x0b\x04\
\0\x0cremove-paths\x01\x0b\x01@\0\0\x03\x04\0\x10is-clean-tracked\x01\x0c\x01j\x01\
y\x01s\x01@\0\0\x0d\x04\0\x17commits-behind-upstream\x01\x0e\x04\0\x0bis-diverge\
d\x01\x0c\x03\0\x14patina:git/git@0.1.0\x05!\x01B\x0f\x01ps\x01r\x06\x0awatch-pa\
ths\x0bstream-names\x09recursive\x7f\x0einclude-hidden\x7f\x16emit-existing-on-s\
tart\x7f\x0aextensions\0\x04\0\x0ewatcher-config\x03\0\x01\x01ks\x01kw\x01r\x08\x05\
ticksw\x05scansw\x10files-seen-totalw\x16changes-detected-totalw\x14events-emitt\
ed-totalw\x0clast-scan-at\x03\x0alast-error\x03\x15last-scan-duration-ms\x04\x04\
\0\x0dwatcher-stats\x03\0\x05\x01r\x03\x0asize-bytesw\x10modified-unix-msw\x06sh\
a256s\x04\0\x10file-fingerprint\x03\0\x07\x01m\x03\x07created\x08modified\x07del\
eted\x04\0\x0bchange-kind\x03\0\x09\x01r\x09\x07watchers\x0bstream-names\x0bchan\
ge-kind\x0a\x0dabsolute-paths\x0drelative-paths\x0asize-bytes\x04\x10modified-un\
ix-ms\x04\x06sha256\x03\x0bdetected-ats\x04\0\x0bfile-change\x03\0\x0b\x01r\x06\x0a\
files-seenw\x07createdw\x08modifiedw\x07deletedw\x07emittedw\x0bduration-msw\x04\
\0\x0cscan-outcome\x03\0\x0d\x03\0\x18patina:watch/types@0.1.0\x05\"\x02\x03\0\x12\
\x0bfile-change\x01B\x05\x02\x03\x02\x01#\x04\0\x0bfile-change\x03\0\0\x01j\0\x01\
s\x01@\x01\x06change\x01\0\x02\x04\0\x04emit\x01\x03\x03\0\x19patina:watch/event\
s@0.1.0\x05$\x01@\0\x01\0\x04\0\x04init\x01%\x01@\0\0s\x04\0\x04name\x01&\x01j\0\
\x01s\x01@\0\0'\x04\0\x07on-load\x01(\x04\0\x09on-unload\x01%\x01@\0\0\x02\x04\0\
\x06health\x01)\x01j\x01s\x01s\x01@\x02\x06actions\x07payloads\0*\x04\0\x06handl\
e\x01+\x01p\x04\x01j\x01,\x01s\x01@\x01\x05limity\0-\x04\0\x05drain\x01.\x01p\x06\
\x01@\0\0/\x04\0\x04tick\x010\x02\x03\0\x12\x0ewatcher-config\x02\x03\0\x12\x0dw\
atcher-stats\x02\x03\0\x12\x0cscan-outcome\x01B\x11\x02\x03\x02\x011\x04\0\x0ewa\
tcher-config\x03\0\0\x02\x03\x02\x012\x04\0\x0dwatcher-stats\x03\0\x02\x02\x03\x02\
\x013\x04\0\x0cscan-outcome\x03\0\x04\x01j\x01\x01\x01s\x01@\x02\x06config\x01\x0e\
reset-snapshot\x7f\0\x06\x04\0\x09configure\x01\x07\x01@\0\0\x03\x04\0\x06status\
\x01\x08\x01j\x01\x05\x01s\x01@\0\0\x09\x04\0\x08scan-now\x01\x0a\x01j\0\x01s\x01\
@\0\0\x0b\x04\0\x05reset\x01\x0c\x04\0\x1apatina:watch/control@0.1.0\x054\x04\02\
patina:folder-watch-actor/folder-watch-actor@0.1.0\x04\0\x0b\x18\x01\0\x12folder\
-watch-actor\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x07\
